...
Docker and Nginx is a simple way to bypass Same Origin Policy during development JS apps using API.  This repository contains a nginx.conf and Dockerfile. It allows you to create a simple local reverse proxy.
